  ...
  children: [
    {
      ...
      children: [
        {
          type: 'file',
          uri: '/branches/release/v1.0.0',
        },
        {
          type: 'file',
          uri: '/branches/release/v1.1.0',
        },
        {
          type: 'file',
          uri: '/branches/release/v2.0.0',
        },
      ],
    },
    {
      ...
      children: [
        {
          type: 'file',
          uri: '/branches/feature/login-refactor',
        },
        {
          type: 'file',
          uri: '/branches/feature/add-dark-mode',
        },
        {
          type: 'file',
          uri: '/branches/feature/improve-performance',
        },
      ],
    },
    {
    ...
    {
      type: 'file',
      uri: '/branches/develop',
    },
  ],
};

const gitRepoRemoteTree: TreeNode = {
  type: 'directory',
  uri: '/remote',
  expanded: true,
  children: [
    {
      ...
      children: [
        {
          type: 'file',
          uri: '/remote/release/v1.0.0',
        },
        {
          type: 'file',
          uri: '/remote/release/v1.1.0',
        },
        {
          type: 'file',
          uri: '/remote/release/v2.0.0',
        },
      ],
    },
    {
      ...
      children: [
        {
          type: 'file',
          uri: '/remote/feature/login-refactor',
        },
        {
          type: 'file',
          uri: '/remote/feature/add-dark-mode',
        },
        {
          type: 'file',
          uri: '/remote/feature/improve-performance',
        },
      ],
    },
    {
...
export default function SourceTree() {
  ...
  const [remoteTree, setRemoteTree] = useState<TreeNode | undefined>(
    gitRepoRemoteTree,
  );
  ...
  const toggleExpandedRemote: FileTreeProps['onItemClick'] = (
    treeNode: TreeNode,
  ) => {
    if (treeNode.type !== 'directory') {
      SetSelectedBranch(treeNode.uri);
  ...
  return (
    <div className="SourceTreeContainer">
      ...
      {/* <FileTree
        tree={remoteTree}
        onItemClick={toggleExpandedRemote}
        itemRenderer={itemRenderer}
        activatedUri={selectedBranch}
        draggable // TODO: open context menu on release
      /> */}
